...
import com.sansoft.harmony.database.stream.model.StreamEntity.Companion.STREAM_ID
import com.sansoft.harmony.database.stream.model.StreamStateEntity.Companion.JOIN_STREAM_ID
import com.sansoft.harmony.database.stream.model.StreamStateEntity.Companion.PLAYBACK_FINISHED_END_MILLISECONDS
import com.sansoft.harmony.database.stream.model.StreamStateEntity.Companion.STREAM_STATE_TABLE
...
data class StreamStateEntity(
    ...
    companion object {
         ...
         * (60000ms = 60s).
         * @see com.sansoft.harmony.database.stream.model.StreamStateEntity.isFinished
         */
