package com.sansoft.harmony.local.subscription.dialog
...
import com.sansoft.harmony.databinding.DialogFeedGroupCreateBinding
import com.sansoft.harmony.databinding.ToolbarSearchLayoutBinding
import com.sansoft.harmony.fragments.BackPressable
import com.sansoft.harmony.local.subscription.FeedGroupIcon
import com.sansoft.harmony.local.subscription.dialog.FeedGroupDialog.ScreenState.DeleteScreen
import com.sansoft.harmony.local.subscription.dialog.FeedGroupDialog.ScreenState.IconPickerScreen
import com.sansoft.harmony.local.subscription.dialog.FeedGroupDialog.ScreenState.InitialScreen
import com.sansoft.harmony.local.subscription.dialog.FeedGroupDialog.ScreenState.SubscriptionsPickerScreen
import com.sansoft.harmony.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.ProcessingEvent
import com.sansoft.harmony.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.SuccessEvent
import com.sansoft.harmony.local.subscription.item.ImportSubscriptionsHintPlaceholderItem
import com.sansoft.harmony.local.subscription.item.PickerIconItem
import com.sansoft.harmony.local.subscription.item.PickerSubscriptionItem
