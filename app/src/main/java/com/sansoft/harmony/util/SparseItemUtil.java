...
public final class SparseItemUtil {
     ...
     * com.sansoft.harmony.extractor.feed.FeedExtractor}. FeedExtractors provide a fast and
     * lightweight method to fetch info, but the info might be incomplete (see
     * {@link com.sansoft.harmony.local.feed.service.FeedLoadService} for more details).
     *
     ...
     *                 com.sansoft.harmony.extractor.stream.StreamInfo}
     */
     ...
     * com.sansoft.harmony.extractor.feed.FeedExtractor}). A toast is shown if loading details is
     * required.
     *
     * @param context     Android context
     ...
     *                    com.sansoft.harmony.extractor.stream.StreamInfo} corresponding to the item
     */
