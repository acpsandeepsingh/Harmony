...
import static com.sansoft.harmony.player.Player.RENDERER_UNAVAILABLE;
import static com.sansoft.harmony.player.Player.STATE_BUFFERING;
...
import static com.sansoft.harmony.player.Player.STATE_PAUSED_SEEK;
import static com.sansoft.harmony.player.Player.STATE_PLAYING;
import static com.sansoft.harmony.player.helper.PlayerHelper.formatSpeed;
import static com.sansoft.harmony.player.helper.PlayerHelper.getTimeString;
import static com.sansoft.harmony.player.helper.PlayerHelper.nextResizeModeAndSaveToPrefs;
...
import com.sansoft.harmony.player.gesture.DisplayPortion;
import com.sansoft.harmony.player.helper.PlayerHelper;
import com.sansoft.harmony.player.mediaitem.MediaItemTag;
import com.sansoft.harmony.player.playback.SurfaceHolderCallback;
import com.sansoft.harmony.player.playqueue.PlayQueue;
import com.sansoft.harmony.player.playqueue.PlayQueueItem;
import com.sansoft.harmony.player.seekbarpreview.SeekbarPreviewThumbnailHelper;
import com.sansoft.harmony.player.seekbarpreview.SeekbarPreviewThumbnailHolder;
...
import com.sansoft.harmony.views.player.PlayerFastSeekOverlay;
    ...
    public boolean onKeyDown(final int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_CENTER:
                ...
                if (player.getCurrentState() == com.sansoft.harmony.player.Player.STATE_BLOCKED) {
                    return true;
                }
