 ...
 * player) is running and is bound to {@link com.sansoft.harmony.player.helper.PlayerHolder}.
 * "Disconnected" means that either the service (resp. the player) was stopped completely, or that
 * {@link com.sansoft.harmony.player.helper.PlayerHolder} is not bound.
 */
public interface PlayerServiceExtendedEventListener extends PlayerServiceEventListener {
    /**
     * The player service just connected to {@link com.sansoft.harmony.player.helper.PlayerHolder},
     ...
     * completely, or {@link com.sansoft.harmony.player.helper.PlayerHolder} is unbinding.
     */
    void onPlayerDisconnected();

    /**
     * The service got disconnected from {@link com.sansoft.harmony.player.helper.PlayerHolder},
     * either because {@link com.sansoft.harmony.player.helper.PlayerHolder} is unbinding or because
