package com.sansoft.harmony.player.ui;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static com.sansoft.harmony.MainActivity.DEBUG;
import static com.sansoft.harmony.QueueItemMenuUtil.openPopupMenu;
import static com.sansoft.harmony.extractor.ServiceList.YouTube;
import static com.sansoft.harmony.ktx.ViewUtils.animate;
import static com.sansoft.harmony.player.Player.STATE_COMPLETED;
import static com.sansoft.harmony.player.Player.STATE_PAUSED;
import static com.sansoft.harmony.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_BACKGROUND;
import static com.sansoft.harmony.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_NONE;
import static com.sansoft.harmony.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_POPUP;
import static com.sansoft.harmony.player.helper.PlayerHelper.getMinimizeOnExitAction;
import static com.sansoft.harmony.player.helper.PlayerHelper.getTimeString;
import static com.sansoft.harmony.player.helper.PlayerHelper.globalScreenOrientationLocked;
...
import com.sansoft.harmony.extractor.stream.StreamSegment;
import com.sansoft.harmony.fragments.OnScrollBelowItemsListener;
import com.sansoft.harmony.fragments.detail.VideoDetailFragment;
import com.sansoft.harmony.info_list.StreamSegmentAdapter;
import com.sansoft.harmony.info_list.StreamSegmentItem;
...
import com.sansoft.harmony.player.gesture.BasePlayerGestureListener;
import com.sansoft.harmony.player.gesture.MainPlayerGestureListener;
import com.sansoft.harmony.player.helper.PlaybackParameterDialog;
...
import com.sansoft.harmony.player.playqueue.PlayQueueAdapter;
import com.sansoft.harmony.player.playqueue.PlayQueueItem;
import com.sansoft.harmony.player.playqueue.PlayQueueItemBuilder;
import com.sansoft.harmony.player.playqueue.PlayQueueItemHolder;
import com.sansoft.harmony.player.playqueue.PlayQueueItemTouchCallback;
import com.sansoft.harmony.util.DeviceUtils;
import com.sansoft.harmony.util.NavigationHelper;
import com.sansoft.harmony.util.external_communication.KoreUtils;
