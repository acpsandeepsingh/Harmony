...
import static com.sansoft.harmony.extractor.ServiceList.YouTube;
import static com.sansoft.harmony.extractor.utils.Utils.isNullOrEmpty;
import static com.sansoft.harmony.player.helper.PlayerHelper.retrievePlaybackParametersFromPrefs;
import static com.sansoft.harmony.player.helper.PlayerHelper.retrieveSeekDurationFromPreferences;
import static com.sansoft.harmony.player.helper.PlayerHelper.savePlaybackParametersToPrefs;
import static com.sansoft.harmony.player.notification.NotificationConstants.ACTION_CLOSE;
import static com.sansoft.harmony.player.notification.NotificationConstants.ACTION_FAST_FORWARD;
import static com.sansoft.harmony.player.notification.NotificationConstants.ACTION_FAST_REWIND;
import static com.sansoft.harmony.player.notification.NotificationConstants.ACTION_PLAY_NEXT;
import static com.sansoft.harmony.player.notification.NotificationConstants.ACTION_PLAY_PAUSE;
import static com.sansoft.harmony.player.notification.NotificationConstants.ACTION_PLAY_PREVIOUS;
import static com.sansoft.harmony.player.notification.NotificationConstants.ACTION_RECREATE_NOTIFICATION;
import static com.sansoft.harmony.player.notification.NotificationConstants.ACTION_REPEAT;
import static com.sansoft.harmony.player.notification.NotificationConstants.ACTION_SHUFFLE;
import static com.sansoft.harmony.util.ListHelper.getPopupResolutionIndex;
import static com.sansoft.harmony.util.ListHelper.getResolutionIndex;
...
import com.sansoft.harmony.databinding.PlayerBinding;
...
import com.sansoft.harmony.player.event.PlayerEventListener;
import com.sansoft.harmony.player.event.PlayerServiceEventListener;
import com.sansoft.harmony.player.helper.AudioReactor;
import com.sansoft.harmony.player.helper.CustomRenderersFactory;
import com.sansoft.harmony.player.helper.LoadController;
import com.sansoft.harmony.player.helper.PlayerDataSource;
import com.sansoft.harmony.player.helper.PlayerHelper;
import com.sansoft.harmony.player.mediaitem.MediaItemTag;
import com.sansoft.harmony.player.mediasession.MediaSessionPlayerUi;
import com.sansoft.harmony.player.notification.NotificationPlayerUi;
import com.sansoft.harmony.player.playback.MediaSourceManager;
import com.sansoft.harmony.player.playback.PlaybackListener;
import com.sansoft.harmony.player.playqueue.PlayQueue;
import com.sansoft.harmony.player.playqueue.PlayQueueItem;
import com.sansoft.harmony.player.playqueue.SinglePlayQueue;
import com.sansoft.harmony.player.resolver.AudioPlaybackResolver;
import com.sansoft.harmony.player.resolver.VideoPlaybackResolver;
import com.sansoft.harmony.player.resolver.VideoPlaybackResolver.SourceType;
import com.sansoft.harmony.player.ui.BackgroundPlayerUi;
import com.sansoft.harmony.player.ui.MainPlayerUi;
import com.sansoft.harmony.player.ui.PlayerUi;
import com.sansoft.harmony.player.ui.PlayerUiList;
import com.sansoft.harmony.player.ui.PopupPlayerUi;
import com.sansoft.harmony.player.ui.VideoPlayerUi;
import com.sansoft.harmony.util.DependentPreferenceHelper;
...
import com.sansoft.harmony.util.StreamTypeUtil;
