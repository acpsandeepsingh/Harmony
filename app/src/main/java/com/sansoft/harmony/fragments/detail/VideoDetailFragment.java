package com.sansoft.harmony.fragments.detail;

import static android.text.TextUtils.isEmpty;
import static com.sansoft.harmony.extractor.StreamingService.ServiceInfo.MediaCapability.COMMENTS;
import static com.sansoft.harmony.extractor.stream.StreamExtractor.NO_AGE_LIMIT;
import static com.sansoft.harmony.ktx.ViewUtils.animate;
import static com.sansoft.harmony.ktx.ViewUtils.animateRotation;
import static com.sansoft.harmony.player.helper.PlayerHelper.globalScreenOrientationLocked;
import static com.sansoft.harmony.player.helper.PlayerHelper.isClearingQueueConfirmationRequired;
import static com.sansoft.harmony.util.DependentPreferenceHelper.getResumePlaybackEnabled;
import static com.sansoft.harmony.util.ExtractorHelper.showMetaInfoInTextView;
import static com.sansoft.harmony.util.ListHelper.getUrlAndNonTorrentStreams;
import static com.sansoft.harmony.util.NavigationHelper.openPlayQueue;
...
import com.sansoft.harmony.App;
import com.sansoft.harmony.R;
import com.sansoft.harmony.database.stream.model.StreamEntity;
import com.sansoft.harmony.databinding.FragmentVideoDetailBinding;
...
import com.sansoft.harmony.fragments.BaseStateFragment;
import com.sansoft.harmony.fragments.EmptyFragment;
import com.sansoft.harmony.fragments.MainFragment;
import com.sansoft.harmony.fragments.list.comments.CommentsFragment;
import com.sansoft.harmony.fragments.list.videos.RelatedItemsFragment;
...
import com.sansoft.harmony.local.playlist.LocalPlaylistFragment;
import com.sansoft.harmony.player.Player;
import com.sansoft.harmony.player.PlayerIntentType;
import com.sansoft.harmony.player.PlayerService;
import com.sansoft.harmony.player.PlayerType;
import com.sansoft.harmony.player.event.OnKeyDownListener;
import com.sansoft.harmony.player.event.PlayerServiceExtendedEventListener;
...
import com.sansoft.harmony.util.InfoCache;
...
import com.sansoft.harmony.util.PlayButtonHelper;
